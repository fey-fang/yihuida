...
rs.open"select * from axw where xwlb_id="&xwlb_id&" order by tjsj desc",cn,1,3
else
set rs=server.CreateObject("adodb.recordset")
rs.open"select * from axw  order by id desc",cn,1,3
end if
...
if xwlb_id<>"" then
xwlbmc="<a href='axw_list.asp?xwlb_id="&xwlb_id&"'>"&rs1("xwlb")&"</a> > "
xx=rs1("xwlb")
enxx=rs1("enxwlb")
else
xx="新闻中心"
...
set rsdl=nothing%> 
      ...
      <!--right start-->
      <div class="right">
        <div class="Position"><span>你的位置：<a href="index.asp" >首页</a> > <a href="axw_list.asp"  >新闻资讯</a>  >  <a href="axw_list.asp?xwlb_id=<%=xwlb_id%>"  ><%=xx%></a></span></div>
        <div class="HeightTab clearfix"></div>
        <!--main start-->
        <div class="main">
          <div class="ArticleList">
            <table  width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <%for i=1 to cur_recordcounts%> 
                <tr>
                  <td width='90%' class='fw_t'><a href="axw_view.asp?id=<%=rs("id")%>" title="<%=rs("xwbt")%>"><%=rs("xwbt")%></a></td>
...
Response.Write"<li><a href=""axw_list.asp?pages=1&xwlb_id="&xwlb_id&"""> << </a></li>"
end if

if pages>1 then
response.Write"<li><a href=""axw_list.asp?pages="&pages-1&"&xwlb_id="&xwlb_id&""" > < </a></li>"
else
Response.Write"<li><a> < </a></li>"
end if
...
if i<start+11 then
response.Write"<li><a href=""axw_list.asp?pages="&i&"&xwlb_id="&xwlb_id&""" title="""&i&""">"&i&"</a></li>"
else
exit for
end if
end if
...
Response.Write"<li><a href=""axw_list.asp?pages="&cur_c&"&xwlb_id="&xwlb_id&"""> >> </a></li>"
end if%>
<%end if%>
          </ul>
        </div>
